...
// const generateProejcts = (projectsArr) => {
...
// 	const featuredProjectHtmlArr = featuredProjects.map((project) => {
// 		const { name, description, languages, link } = project;
// 		return `
...
// 	const nonfeaturedProjectHtmlArr = nonfeaturedProjects.map((project) => {
// 		const { name, description, languages, link } = project;
